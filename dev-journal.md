...
- `LOCK` se activa/desactiva presionando juntas las posiciones thumb 54, 55 y
  58, sin importar la layer activa. La layer usa `&none` en todas las teclas
  para no caer a layers inferiores.
